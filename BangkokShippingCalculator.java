// นี่คือคลาส BangkokShippingCalculator ซึ่งเป็นคลาสที่สืบทอดมาจาก FlashShippingCalculator2
// คลาสนี้ใช้สำหรับคำนวณค่าจัดส่งภายในกรุงเทพ
public class BangkokShippingCalculator extends FlashShippingCalculator2 {
    @Override
    ...
    @Override
    // เมธอดนี้Overrideเมธอด calculateShippingCostToOtherProvinces ในคลาสหลัก
    ...
    public double calculateShippingCost(double weight, double width, double length, double height) {
        return calculateShippingCostInBangkok(weight, width, length, height);
    }
}